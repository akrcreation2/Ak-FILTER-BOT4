...
from info import CHANNELS, ADMINS, LOG_CHANNEL, PICS, BATCH_FILE_CAPTION, CUSTOM_FILE_CAPTION, PROTECT_CONTENT, IS_VERIFY, HOW_TO_VERIFY
from utils import get_settings, get_size, is_subscribed, save_group_settings, temp, create_invite_links, verify_user, check_token, check_verification, get_token
...
async def start(client, message):
        ...
        buttons = [
              [
                  InlineKeyboardButton('⤬ Aᴅᴅ Mᴇ Tᴏ Yᴏᴜʀ Gʀᴏᴜᴘ ⤬', url=f'http://t.me/{temp.U_NAME}?startgroup=true')
                    ...
                    InlineKeyboardButton('⌬ Mᴏᴠɪᴇ Gʀᴏᴜᴘ', url="https://t.me/movie_request_group_knmlpro2 ")
                ],[
    ...
    if len(message.command) != 2:
        buttons = [[
            InlineKeyboardButton("⚆ ʜᴏᴡ ᴛᴏ ᴜꜱᴇ ᴛʜᴇ ʙᴏᴛ ⚆", callback_data="henge")
            ],[
            InlineKeyboardButton("֎ ᴀᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ֎", url=f"http://t.me/{temp.U_NAME}?startgroup=true")
            ],[
            InlineKeyboardButton("♛ ᴊᴏɪɴ ᴏᴜʀ ᴍᴀɪɴ ᴄʜᴀɴɴᴇʟ ♛", url="https://t.me/+pZsXBpmZGrczNGM1")
            ],[
            InlineKeyboardButton("𖤓 ʜᴇʟᴘ 𖤓", callback_data="help"),
            InlineKeyboardButton("☠︎︎ ᴀʙᴏᴜᴛ ☠︎︎", callback_data="about")
            ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        #add emoji loading then run 1 sec and dlt
        m=await message.reply_text("ನಮಸ್ಕಾರ ದೇವ್ರು 🙏") 
