...
from info import LONG_IMDB_DESCRIPTION, MAX_LIST_ELM, IS_VERIFY, HOW_TO_VERIFY, PROTECT_CONTENT, SHORTLINK_URL, SHORTLINK_API, VERIFY2_URL, VERIFY2_API, LOG_CHANNEL
